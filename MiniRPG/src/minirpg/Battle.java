...
//                System.out.println(monsters.get(0).getCol());
    ...
    public void moveUp() {
        ...
        while (x <= 3) {
            int r = MiniRPG.players.get(x).getRow();
            int c = MiniRPG.players.get(x).getColoum();
            if (MiniRPG.players.get(x).getColoum() == table.getSelectedColumn()) {
                selectedPlayerColumn = true;
            }
            if (MiniRPG.players.get(x).getRow() == table.getSelectedRow()) {
            ...
            if (check == true) {
                System.out.println(MiniRPG.players.get(x).getRow());
                MiniRPG.players.get(x).setRow(r - 1);
                System.out.println(r);
                table.setValueAt(MiniRPG.players.get(x).getName(), r, c);
                check = false;
                remove = true;
            }
            if (remove == true){
